...
{
    public class BusquedaMarcaLogica
    {
        private MarcaADO contexto;
        ...
        public BusquedaMarcaLogica()
        {
            contexto = new MarcaADO();
        }

        public void ListarRegistros()
        {
            LstMarca = contexto.ListarMarcas();
        }

        public clsMARCA ObtenerRegistro(int id)
        {
            return contexto.ObtenerMarca(id);
        }
